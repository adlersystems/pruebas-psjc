<?php
  $fechaFormInicio = $_POST['fechaInicio'];
  $fechaConvertInicio = strtotime($fechaFormInicio);
  $fechaInicio = date('Y-m-d',$fechaConvertInicio);
  
  $fechaFormFin = $_POST['fechaFin'];
  $fechaConvertFin = strtotime($fechaFormFin);
  $fechaFin = date('Y-m-d',$fechaConvertFin);
  
  $titulo = $_POST['titulo'];
  
  $contenido = $_POST['content2'];
  ...
  $sql = "INSERT INTO avisos (id, inicio, expiracion, titulo, contenido)
  VALUES (NULL, '$fechaInicio', '$fechaFin', '$titulo','$contenido')";
?>
  ...
  <div data-role="page" id="home" data-theme="e">
	...
	<div role="main" class="ui-content">
	  ...
	  if ($conn->query($sql) === TRUE) {
		  ...
		  echo '<h3>Aviso insertado con éxito.</h3>';
